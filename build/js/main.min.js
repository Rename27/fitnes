...
/* harmony import */ var _modules_coach_swiper__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/coach-swiper */ "./js/modules/coach-swiper.js");
...
new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default.a('.coaches__swiper', {
  navigation: {
...
new _vendor_swiper__WEBPACK_IMPORTED_MODULE_0___default.a('.reviews__swiper', {
  navigation: {
    prevEl: '.swiper-button-prev',
    nextEl: '.swiper-button-next'
  },
...
var prices = document.querySelectorAll('.cards__price-wrapper h3');
var pricesShadow = document.querySelectorAll('.cards__price span');

var nextTab = function nextTab(evt) {
  evt.preventDefault();
...
var setPrice = function setPrice(evt) {
...
function setupVideo(video) {
  var link = video.querySelector('.video a');
